...
#[doc = "Field `RB_MCR_OUT2` reader - UART2 control OUT2"]
pub type RbMcrOut2R = crate::BitReader;
#[doc = "Field `RB_MCR_OUT2` writer - UART2 control OUT2"]
...
impl W {
    #[doc = "Bit 3 - UART2 control OUT2"]
    #[inline(always)]
    pub fn rb_mcr_out2(&mut self) -> RbMcrOut2W<'_, R8Uart2McrSpec> {
        RbMcrOut2W::new(self, 3)
    }
    #[doc = "Bit 5 - UART0 enable autoflow control"]
    #[inline(always)]
    pub fn rb_mcr_au_flow_en(&mut self) -> RbMcrAuFlowEnW<'_, R8Uart2McrSpec> {
