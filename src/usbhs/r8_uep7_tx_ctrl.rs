...
pub type R = crate::R<R8Uep7TxCtrlSpec>;
#[doc = "Register `R8_UEP7_TX_CTRL` writer"]
pub type W = crate::W<R8Uep7TxCtrlSpec>;
...
impl W {
    #[doc = "Bits 0:1 - bit mask of handshake response type for USB endpoint X transmittal (IN)"]
    #[inline(always)]
    pub fn rb_uep_tres_mask(&mut self) -> RbUepTresMaskW<'_, R8Uep7TxCtrlSpec> {
        RbUepTresMaskW::new(self, 0)
    }
    #[doc = "Bit 2 - expected no response"]
    #[inline(always)]
    pub fn rb_uep_tres_no(&mut self) -> RbUepTresNoW<'_, R8Uep7TxCtrlSpec> {
        RbUepTresNoW::new(self, 2)
    }
    #[doc = "Bits 3:4 - prepared data toggle flag of USB endpoint X transmittal"]
    #[inline(always)]
    pub fn rb_uep_t_tog_mask(&mut self) -> RbUepTTogMaskW<'_, R8Uep7TxCtrlSpec> {
        RbUepTTogMaskW::new(self, 3)
    }
    #[doc = "Bit 5 - enable automatic toggle after successful transfer completion on endpoint 0"]
    #[inline(always)]
    pub fn rb_uep_t_autotog(&mut self) -> RbUepTAutotogW<'_, R8Uep7TxCtrlSpec> {
        RbUepTAutotogW::new(self, 5)
    }
}
#[doc = "endpoint 7 tx control\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_uep7_tx_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r8_uep7_tx_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R8Uep7TxCtrlSpec;
impl crate::RegisterSpec for R8Uep7TxCtrlSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`r8_uep7_tx_ctrl::R`](R) reader structure"]
impl crate::Readable for R8Uep7TxCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`r8_uep7_tx_ctrl::W`](W) writer structure"]
impl crate::Writable for R8Uep7TxCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets R8_UEP7_TX_CTRL to value 0"]
impl crate::Resettable for R8Uep7TxCtrlSpec {}
