...
pub type R = crate::R<R8Uep5RxCtrlSpec>;
#[doc = "Register `R8_UEP5_RX_CTRL` writer"]
pub type W = crate::W<R8Uep5RxCtrlSpec>;
...
impl W {
    #[doc = "Bits 0:1 - bit mask of handshake response type for USB endpoint X receiving (OUT)"]
    #[inline(always)]
    pub fn rb_uep_rres_mask(&mut self) -> RbUepRresMaskW<'_, R8Uep5RxCtrlSpec> {
        RbUepRresMaskW::new(self, 0)
    }
    #[doc = "Bit 2 - prepared no response"]
    #[inline(always)]
    pub fn rb_uep_rres_no(&mut self) -> RbUepRresNoW<'_, R8Uep5RxCtrlSpec> {
        RbUepRresNoW::new(self, 2)
    }
    #[doc = "Bits 3:4 - expected data toggle flag of USB endpoint X receiving"]
    #[inline(always)]
    pub fn rb_uep_r_tog_mask(&mut self) -> RbUepRTogMaskW<'_, R8Uep5RxCtrlSpec> {
        RbUepRTogMaskW::new(self, 3)
    }
    #[doc = "Bit 5 - enable automatic toggle after successful transfer completion on endpoint"]
    #[inline(always)]
    pub fn rb_uep_r_autotog(&mut self) -> RbUepRAutotogW<'_, R8Uep5RxCtrlSpec> {
        RbUepRAutotogW::new(self, 5)
    }
}
#[doc = "endpoint 5 rx control\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_uep5_rx_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r8_uep5_rx_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R8Uep5RxCtrlSpec;
impl crate::RegisterSpec for R8Uep5RxCtrlSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`r8_uep5_rx_ctrl::R`](R) reader structure"]
impl crate::Readable for R8Uep5RxCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`r8_uep5_rx_ctrl::W`](W) writer structure"]
impl crate::Writable for R8Uep5RxCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets R8_UEP5_RX_CTRL to value 0"]
impl crate::Resettable for R8Uep5RxCtrlSpec {}
